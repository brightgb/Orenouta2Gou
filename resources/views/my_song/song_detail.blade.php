...
@else
    <div style="padding-top: 70px; margin: 150px 0 70px 0; width: 100%; text-align: center; clear: both;">
...
<div id="modal-content">
    <form method="post" onsubmit="return check()" action="/song_advice/post">
        <p style="font-size: small;">最大３００文字</p>
        {{ csrf_field() }}
