...
<div style="width: 90vw; margin: 0 auto; padding-bottom: 100px;">
    ...
    サイトを閲覧していてお気づきになった不具合や投稿してほしい曲等がございましたら、お気軽に送信ください。<br><br>
    <form method="post" onSubmit="return check()">
        {{ csrf_field() }}
        <p>最大３００文字</p>
        <textarea name="question" style="width: 95%; height: 100px;" maxlength="300" required></textarea><br><br>
