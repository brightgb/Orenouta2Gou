...
@section('content_header', 'アカウント作成')
    ...
    <form method="post" action="/admin/account/store">
        ...
        <table id="serch_form1" border="1">
            ...
            <tr>
                <th>ログインID</th>
                <td>
                    <input type="text" name="userid" size="30" value="{{ old('userid') }}" required>　半角英数
                </td>
            </tr>
            <tr>
                <th>パスワード</th>
                <td>
                    <input type="text" name="password_org" size="30" value="{{ old('password_org') }}" required>　半角英数
                </td>
            </tr>
        </table>
        <div>
