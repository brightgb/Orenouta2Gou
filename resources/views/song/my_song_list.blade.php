...
<div class="absolute_part">
    ...
    <div class="cp_ipselect cp_sl01">
        <select onchange="location.href=value;">
            <option value="/song/account/my_song?sort=1" @if ($sort == 1) selected @endif>
                投稿の最新順
            </option>
            <option value="/song/account/my_song?sort=2" @if ($sort == 2) selected @endif>
                投稿の古い順
            </option>
            <option value="/song/account/my_song?sort=3" @if ($sort == 3) selected @endif>
                アドバイスの多い順
            </option>
            <option value="/song/account/my_song?sort=4" @if ($sort == 4) selected @endif>
                アドバイスの少ない順
            </option>
        </select>
    </div>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td class="detail_text">
                            <a href="/song/account/my_song_detail/{{ $item['id'] }}" style="font-weight: bold; text-decoration: none; color: blue;">
                                {{ $item['title'] }}
                            </a>
                        </td>
                    </tr>
