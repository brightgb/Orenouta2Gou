...
//	var $detect_order				= "iso-2022-jp,eucJP-win,UTF-8,SJIS-win,jis,ASCII";
	...
	'host'		=> 'ubuntu2019.crea-live.com' ,
	'port'		=> 8025 ,
	'from'		=> 'douhou-returnmail',
	'user'		=> '',
	'pass' 		=> '',
	'protocol'	=> 'SMTP',
	'pop_host'	=> '',
...
EOF;
	...
	function & smtpObject( $null = false ){
		...
		if( !class_exists ( 'Qdsmtp' ) && file_exists( '../app/Library/Qdsmtp.php' ) ){
			require_once( '../app/Library/Qdsmtp.php' );
		...
		$this->smtp_object = new Qdsmtp_ex();
		return $this->smtp_object;
	}
